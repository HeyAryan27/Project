...
const ProjectTimeline = () => {
  return (
    <div className="bg-white p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 rounded-lg shadow-md border border-gray-200 mx-auto max-w-full sm:max-w-lg lg:max-w-xl lg:h-full xl:max-w-5xl">
      <div className="text-left mb-4">
        ...
        <p
          style={{ fontSize: "14px" }}
          className="text-xs sm:text-sm lg:text-base text-gray-500"
        >
      ...
      <div className="relative pl-2 sm:pl-4 md:pl-6 lg:pl-6">
        <div className="absolute h-full border-l-2 border-teal-600 left-8 sm:left-4 lg:left-12" style={{zIndex: "1"}}></div>
        ...
        {milestones.map((milestone, index) => (
          ...
          >
            ...
            <div className="bg-white border border-teal-200 rounded-lg p-1 md:p-1 lg:p-1 w-full max-w-[80%] sm:max-w-[90%] lg:max-w-[95%] shadow-sm">
              <div className="flex gap-2 items-center">
                <div className="flex items-center justify-center bg-teal-100 text-teal-600 w-6 h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 rounded-full">
                  <FaFlag className="w-2 h-2 md:w-4 md:h-4 lg:w-5 lg:h-5" />
                </div>
                <div>
                  <h3
                  ...
                  <div className="flex items-center text-gray-500 text-xs md:text-sm lg:text-base space-x-1 md:space-x-2">
                    ...
                    <span style={{ fontSize: "13px" }}>{milestone.date}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="w-full mt-4 sm:mt-6 ml-6 flex ">
