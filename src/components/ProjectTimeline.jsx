  ...
  return (
    <div className="bg-white p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 rounded-lg shadow-md border border-gray-200 mx-auto max-w-full sm:max-w-lg lg:max-w-xl lg:h-full xl:max-w-5xl">
      ...
      <div className="text-left mb-4">
        <h2 className="text-base md:text-lg lg:text-xl font-semibold">Project Timeline</h2>
        <p className="text-xs sm:text-sm lg:text-base text-gray-500">You can check the timeline of the project here</p>
      </div>


      <div className="relative pl-2 sm:pl-4 md:pl-6 lg:pl-8">
    
        <div className="absolute h-full border-l-2 border-teal-600 left-2 sm:left-4 lg:left-6 top-2"></div>
