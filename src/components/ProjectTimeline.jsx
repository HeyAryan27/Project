...
const ProjectTimeline = () => {
  return (
    <div className="">
      <div
        className="p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 rounded-lg bg-white border-[rgba(189,125,73,0.4)] mx-auto max-w-full sm:w-full lg:max-w-xl lg:h-full xl:max-w-5xl"
        style={{ border: "1px solid ", borderColor: "#BD7D4966" }}
      >
